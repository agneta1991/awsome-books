...
A great project which can be used for almost anything, as it is made dynamically, so information can be updated, changed or added through Javascript.

To get a local copy up and running, follow these steps:
<br>
- Choose a directory
- Open a Terminal
- write git clone https://github.com/agneta1991/awsome-books
- get into to directory "awsome-books"
- write: npm install
...
Feel free to check the [issues page](https://github.com/agneta1991/awsome-books/issues).
...
<br>
<br>
[![Star](https://img.shields.io/github/stars/agneta1991/awsome-books?style=social)](https://github.com/agneta1991/awsome-books)
